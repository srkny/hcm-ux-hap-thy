...
sap.ui.define(
    [
      ...
      "sap/ui/Device",
      "hcm/ux/hapv4/model/models",
      "hcm/ux/hapv4/controller/ErrorHandler",
      "com/smod/ux/lib/thirdparty/driver/driver",
      "com/smod/ux/lib/thirdparty/shepherdJS/shepherd",
    ],
    function (UIComponent, Device, models, ErrorHandler, DriverJS, ShepherdJS) {
      "use strict";
  
      return UIComponent.extend("hcm.ux.hapv4.Component", {
        metadata: {
          manifest: "json",
        },
        ...
        init: function () {
          ...
          jQuery.sap.includeStyleSheet(
            sLibraryPath + "/thirdparty/driver/driver.css"
          );
