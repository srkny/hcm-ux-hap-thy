...
sap.ui.define([
	...
	"sap/m/Dialog",
	"hcm/ux/hapv4/utils/UIHelper"
], function (Controller, Dialog, UIHelper) {
	"use strict";

	return Controller.extend("hcm.ux.hapv4.controller.BaseController", {
		onInit: function () {
		...
		_getBusyFragment: function () {
			if (!this.oBusyDialog) {
				this.oBusyDialog = sap.ui.xmlfragment("hcm.ux.hapv4.fragment.GenericBusyDialog", this);
				var sImagePath = jQuery.sap.getModulePath("hcm.ux.hapv4", "/images/loading.gif");
