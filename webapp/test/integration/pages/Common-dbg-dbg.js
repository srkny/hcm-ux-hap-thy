sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("hcm/ux/hapv4/app", ".html");
		...
		return Opa5.extend("hcm.ux.hapv4.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["hcm/ux/hapv4/localService/mockserver"], function (mockserver) {
